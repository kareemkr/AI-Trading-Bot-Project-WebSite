...
const translations = {
  en: {
    ...
    dashboard: {
        ...
        wallet: "Wallet",
        equity_value: "Operational Pulse",
        account_tier: "Account Tier",
        pnl_24h: "Neural Confidence",
  ...
  es: {
    ...
    dashboard: {
        ...
        wallet: "Billetera",
        equity_value: "Pulso Operativo",
        account_tier: "Nivel de Cuenta",
        pnl_24h: "Confianza Neuronal",
  ...
  fr: {
    ...
    dashboard: {
        ...
        wallet: "Portefeuille",
        equity_value: "Pulsation Opérationnelle",
        account_tier: "Niveau de Compte",
        pnl_24h: "Confiance Neurone",
