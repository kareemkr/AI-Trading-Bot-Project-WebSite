...
interface HeroProps {
  onOpenSubscription?: () => void; // kept for compatibility (not used)
}
  ...
  return (
    <section className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
      ...
      <p className="text-muted-foreground max-w-xl text-base md:text-lg mb-8 text-pretty">
        Trade faster and smarter with our secure AI bots. Maximize your investments
        with real-time insights and automation.
      </p>

      <Button
        className="bg-accent hover:bg-accent/90 text-accent-foreground px-8 py-6 rounded-full text-base font-medium group"
        onClick={() => {
